...
print(f"Folder NodeClass: {folder.get_node_class()}")
...
print(f"Method NodeClass: {method.get_node_class()}")
...
if method.get_node_class() == NodeClass.Method:
    print("✅ Метод создан корректно!")
else:
    print("❌ ОШИБКА: Создан не Method!")
